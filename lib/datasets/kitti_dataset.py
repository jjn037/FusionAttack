...
class KittiDataset(torch_data.Dataset):
    def __init__(self, root_dir, split = 'train', blackbox_attack=False):
        self.split = split
        ...
        self.blackbox_attack = blackbox_attack
    ...
    def get_image_rgb_with_normal(self, idx, vis=False):
        """
