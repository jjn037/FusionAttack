...
from lib.net.GAN_model import Generator_fusimg, define_Dimg, Generator_fuspts
...
parser.add_argument('--std_ppts', type=float, default=0.1)
...
if __name__ == "__main__":
    ...
    fn_decorator = train_functions.model_afusg_fn_decorator()
