...
from lib.net.GAN_model import Generator_img, define_Dimg
...
if __name__ == "__main__":
    ...
    fn_decorator = train_functions.model_aimg_fn_decorator()
    ...
    optimizer_D = optim.Adam(discriminator.parameters(), lr=args.lr*2, betas=(0.5, 0.999))
    ...
    trainer = train_utils.Trainer_Aimg(
            model,
            generator,
            discriminator,
